...
namespace NAT
{
	/*public class Ability_HoraxianTracker : Ability
	{
		public class VoidlinkCell : IExposable
		{
			public VoidlinkCell() { }
			...
			public bool Available => cooldownTicks <= 0 && tag.NullOrEmpty();

			public void ExposeData()
			{
				Scribe_Values.Look(ref cooldownTicks, "cooldownTicks", defaultValue: -1);
				Scribe_Values.Look(ref tag, "tag", defaultValue: null);
			}
		}

		public Ability_HoraxianTracker(Pawn pawn)
			: base(pawn)
		{
		}

		public Ability_HoraxianTracker(Pawn pawn, AbilityDef def)
			: base(pawn, def)
		{
		}

		private Gizmo trackerGizmo;

		public List<VoidlinkCell> cells = new List<VoidlinkCell>();

		public bool CanAdvance => false;

		public override IEnumerable<Gizmo> GetGizmosExtra()
		{
			if (trackerGizmo == null)
			{
				trackerGizmo = new HoraxianTrackerGizmo(this);
			}
			yield return trackerGizmo;
		}
		...
		public override IEnumerable<Command> GetGizmos()
		{
			...
			foreach(Command g in base.GetGizmos())
			{
				yield return g;
			}
		}
	...
	public class Command_Voidcast : Command_Ability
	{
		...
		public Command_Voidcast(Psycast ability, Pawn pawn)
			: base(ability, pawn)
		{
		}
	...
	public class HoraxianTrackerGizmo : Gizmo
	{
		private Ability_HoraxianTracker tracker;
		...
		public HoraxianTrackerGizmo(Ability_HoraxianTracker tracker)
		{

...
namespace NAT
{
	public class ActivityWorker_Outside : ActivityWorker
	{
	...
	public class ActivityWorker_Health : ActivityWorker
	{
	...
	public class ActivityWorker_OutsideHealth : ActivityWorker
	{
		private SimpleCurve ActivityGainPerDayFromHealthCurve = new SimpleCurve
		{
			new CurvePoint(0f, 47.9f),
